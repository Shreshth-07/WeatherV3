...
function getWeatherData(city, unit, hourlyorWeek) {
  console.log(city);
  const apiKey = "QC7QHJD39DNKQZX6DUMRSEAPH";
  fetch(
    ...
    .then((data) => {
      ...
      rain.innerText = "Percentage : " + today.precip + " mm";
      ...
      sunRise.innerText = "Sunrise : " + convertTimeTo12HourFormat(today.sunrise);
      sunSet.innerText = "Sunset : " + convertTimeTo12HourFormat(today.sunset);
...
function getIcon(condition) {
  ...
  } else if (condition === "thunder-rain" || condition === "thunder-showers-day" || condition === "thunder-showers-night") {
...
//cities array which we want to suggest
